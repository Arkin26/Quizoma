...
//   console.log("🔍 Quiz Review Debug Logs:");
//   quiz.forEach((q, i) => {
//     console.log(`Q${i + 1}: ${q.question}`);
//     console.log(`  ✅ Correct Answer: ${q.answer}`);
//     console.log(`  📝 Your Answer: ${answers[i] || "Not answered"}`);
//   });
...
//       let logString = `📤 Payload being sent to backend:\n\n`;
//       quiz.forEach((q, i) => {
//         logString += `Q${i + 1}: ${q.question}\n`;
//         logString += `  Options: ${q.options.join(" | ")}\n`;
//         logString += `  Correct Answer: ${q.answer || "N/A"}\n`;
//         logString += `  Explanation: ${q.explanation || "N/A"}\n`;
//         logString += `  Your Answer: ${answers[i] || "Not answered"}\n\n`;
//       });
//       logString += `Total Score: ${correct}/${total}\n`;
//       logString += `Percentage: ${percentage}%\n`;
//       logString += `Time Taken: ${formattedTime}\n`;

//       alert(logString);

//       const response = await fetch("http://localhost:3000/api/quiz/post", {
//         method: "POST",
...
//             <div
//               className={`${getScoreBgColor()} rounded-2xl p-6 mb-6 border-2`}
//             >
...
//             <button
//               onClick={handleSave}
//               className="w-full bg-[#6A0DFF] hover:bg-[#5A0BDB] text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
//             >
...
//                   const isCorrect =
//                     normalize(answers[i]) === normalize(q.answer);
